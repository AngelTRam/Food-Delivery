...
import { keyBy, update } from 'lodash'
import MenuTabScreen from './RestaurantTabs/MenuTabScreen'
import InfoTabScreen from './RestaurantTabs/InfoTabScreen'
import ReviewsTabScreen from './RestaurantTabs/ReviewsTabScreen'
import GalleryTabScreen from './RestaurantTabs/GalleryTabScreen'
    ...
    return (
        <View style={styles.container}>
            <ScrollView>
                        ...
                        <View style={styles.view3}>
                            ...
                            <View style={styles.view4}>
                                ...
                                <Icon
                                    ...
                                    size={15}
                                />
                                <Text style={styles.text5}>{restaurantsData[id].farAway} km away</Text>
                            </View>
                        </View>
                ...
                {
                    index === 0 &&
                    <MenuTabScreen onPress={menuPressed} />
                }
                {
                    index === 1 &&
                    <InfoTabScreen />
